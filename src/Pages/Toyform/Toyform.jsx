...
const Toyform = () => {
    ...
    useTitle("Add Your Toy Products")
    const handleSubmit = (e) => {
        ...
        fetch(`https://toy-server-market.vercel.app/alltoys`, {
            method: "POST",
            headers: {
    ...
    return (
        <div className='bg-blue px-10'>
            <h2 className='text-center pt-5 text-xl font-bold text-white'>Add You Products</h2>
